...
public class IncidentTicket {
    ...
    public List<String> getTags() { return tags != null ? new ArrayList<>(tags) : new ArrayList<>();}// BROKEN: leaks internal list
    ...
    public Builder toBuilder() {
        return new Builder()
                ...
                .tags(new ArrayList<>(this.tags))  // creates defensive copy in Builder
